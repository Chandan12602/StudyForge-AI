...
'''get_chat_response →  a function that generates replies
clear_chat_history → clears stored conversation
get_conversation_summary → summarizes chat history
ROLE_MAP →  a dictionary mapping roles (like user/assistant)'''
...
# Chat input
    ...
    with tab1:
        ...
        def set_research_topic(value):
            st.session_state.research_input = value
